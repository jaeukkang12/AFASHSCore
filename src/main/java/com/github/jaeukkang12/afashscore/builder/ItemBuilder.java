package com.github.jaeukkang12.afashscore.builder;

import com.github.jaeukkang12.afashscore.AfashsCore;
...
public class ItemBuilder {
    ...
    public ItemBuilder setNBT(String key, String value) {
        itemMeta.getPersistentDataContainer().set(new NamespacedKey(JavaPlugin.getProvidingPlugin(AfashsCore.class), key), PersistentDataType.STRING, value);
        return this;
    }
    ...
    public ItemBuilder removeNBT(String key) {
        itemMeta.getPersistentDataContainer().remove(new NamespacedKey(JavaPlugin.getProvidingPlugin(AfashsCore.class), key));
        return this;
    }
